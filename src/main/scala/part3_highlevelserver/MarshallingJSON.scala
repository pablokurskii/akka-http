    ...
    pathPrefix("api" / "player") {
      get {
        path("class" / Segment) { characterClass =>
          ...
          /*TO USE complete like that magically, ADD (search for THIS keyword in this code)*/
        ...
        post {
          /*entity() Extracts HttpEntity from HttpRequest, also converts payload into Player data structure
          * TO USE entity(as[Player]) like that magically, ADD (search for THIS keyword in this code)
          * */
